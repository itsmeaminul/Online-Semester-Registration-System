                ...
                <div class="card-body">
                    <div class="card pt-3 pb-3 mb-2 bg-light ">
                        <form name="add-course-form" onsubmit="return validform()" method="post"
                            action="{{URL::to('/save_regular')}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <!-- First Part Starts -->
                            <div class="row">
                                <div class="col-sm">
                                ...
                                <div class="col-sm">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" id="id_number" class="form-control bg-light border-light" name="std_reg_id" value="{{ Auth::user()->std_id }}" required="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card pt-3 mb-2 pr-5 bg-light">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    <input type="text" id="contact_numbe" class="form-control" name="std_reg_contact" value="{{ Auth::user()->std_contact }}" required="">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            {{-- <label class="col-md-7 col-form-label text-md-center">
                                <input type="Checkbox" class="col-xs-2 border-secondary" name="full-name"> Same as Present Address
                            </label>
                            --}}
                            <div class="form-group row">
