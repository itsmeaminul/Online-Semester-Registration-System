...
<div class="content-wrapper">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="wrapper d-block d-sm-flex align-items-center justify-content-between">
                                ...
                                {{-- <a href="" onclick="printDiv('printableArea')" class="text-md-right btn btn-outline-danger font-weight-bold mt-2">Print The Page</a> --}}
                                {{-- <iframe src="{{URL::to('/view_improve2',Auth:: user()->std_id)}}" style="display:none;" name="frame"></iframe>
                                <input class="text-md-right btn btn-outline-danger font-weight-bold mt-2" type="button" onclick="frames['frame'].print()" value="Print Your Form"> --}}                                
                            </div>
                            {{--  --}}
                            <hr>
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="page1" role="tabpanel" aria-labelledby="page1-tab">
                                        ...
                                        <div class="row d-flex justify-content-center">
                                                        ...
                                                        <div class="col-sm-5 ml-4">
                                                            ...
                                                            <div class="card border-dark text-md-left ml-2 pt-2 bg-danger">
                                                                ...
                                                                <div class="form-group row pl-2">
                                                                    ...
                                                                    <label class="col-md-8 col-form-label text-md-left">: অনিয়মিত</label>
                                                                </div>
                                                            </div>
                                                            </small>
                                                        </div>
                                            ...
                                            সেমিস্টার ফাইনাল পরীক্ষায় অনিয়মিত পরীক্ষার্থী হিসেবে অংশগ্রহণের অনুমতির জন্য।</label>
                                        </div>
        ...
        <table class="text-left border-dark pr-2 text-center" style="width:80%;" border="2">
            ...
            <tr>
                <td>1</td>
                <td>{{$element->imp_course_code1}}</td>
                <td>{{$element->imp_course_title1}}</td>
            </tr>
            <tr>
                <td>2</td>
                <td>{{$element->imp_course_code2}}</td>
                <td>{{$element->imp_course_title2}}</td>
            </tr>
            <tr>
                <td>3</td>
                <td>{{$element->imp_course_code3}}</td>
                <td>{{$element->imp_course_title3}}</td>
            </tr>
            <tr>
                <td>4</td>
                <td>{{$element->imp_course_code4}}</td>
                <td>{{$element->imp_course_title4}}</td>
            </tr>
            <tr>
                <td>5</td>
                <td>{{$element->imp_course_code5}}</td>
                <td>{{$element->imp_course_title5}}</td>
            </tr>
        </table>
        @endforeach
        {{-- officia information --}}
